...
GLFWwindow* ViewManager::CreateDisplayWindow(const char* windowTitle)
{
	...
	// this callback is used to receive scroll wheel input
...
*
* This method is called to process any mouse scroll wheel
* events.
***********************************************************/
void ViewManager::Mouse_Scroll_Wheel_Callback(GLFWwindow* window, double x, double yScrollDistance)
{
	g_pCamera->ProcessMouseScroll((float)yScrollDistance);
}
...
void ViewManager::ProcessKeyboardEvents()
{
	...
	//process camera moveing up and down
	...
	// process camera between perspective and orthographic view
	if (glfwGetKey(m_pWindow, GLFW_KEY_O) == GLFW_PRESS)
	{
		bOrthographicProjection = true;

		// change the camera settings to an orthoghraphic view
...
void ViewManager::PrepareSceneView()
{
	...
	{
		// put projection matrix in orthographic perspective
